        ...
        <div className='bg-white px-[16px] md:px-[162px] pt-12 flex flex-col'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-16'>
                <div className='flex flex-col items-center lg:items-start gap-3'>
                    <Image src='/polimaorange.png' alt='logo' width={300} height={450} className='cursor-pointer' />
                ...
                <div className='flex flex-col items-center gap-3 lg:items-start'>
                    <Image src='/polimagreen.png' alt='logo' width={300} height={450} className='cursor-pointer' />
