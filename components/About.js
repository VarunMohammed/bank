...
const About = () => {
    return(
        <div className='bg-white px-[16px] md:px-[120px] pt-16 lg:pt-32 flex flex-col gap-8 pb-12 items-center lg:items-start h-auto'>
            <motion.div intial={{ y:0, opacity: 0 }} animate={{ y:0, opacity: 1 }} transition={{ duration: 0.5}} className='flex flex-col gap-2 items-center lg:items-start'>
                <h2 className='text-4xl lg:text-7xl xl:text-8xl text-black font-semibold text-center leading-tight lg:text-start'>Experience the Heart of <span className='text-red-600'>Kerala</span></h2>
